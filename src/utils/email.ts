...
const CONFIG = {
  ...
  // Production URL for secure download links
  productionUrl: 'https://techcreator-portfolio.netlify.app'
};
...
/**
 * Get the production base URL for secure download links
 * This ensures links work regardless of where they're generated from
 */
const getProductionBaseUrl = (): string => {
  // Always use production URL for email links to ensure they work everywhere
  if (import.meta.env.PROD || !import.meta.env.DEV) {
    return CONFIG.productionUrl;
  }
  
  // For development, you can still use localhost for testing
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="warning">
              ...
              <p><strong>Important:</strong> Download links will work from anywhere and are not dependent on any development server.</p>
            </div>
          ...
          <div class="content">
            ...
            <div class="timeline">
              ...
              <div style="background: white; padding: 15px; border-radius: 6px; border-left: 4px solid #10b981;">
                <p style="margin: 0;"><strong>📧 Delivery Method:</strong> All documents will be sent to this email address with secure download links that work from anywhere.</p>
              </div>
            </div>
...
export const sendSecureDocumentDelivery = async (data: SecureDocumentDeliveryData): Promise<void> => {
  ...
  // Get production base URL for display in email
          ...
          ${docs.map(doc => `
            <div style="background: white; padding: 15px; border-radius: 6px; border: 1px solid #e5e7eb;">
              ...
              <p style="margin: 5px 0 0 0; font-size: 12px; color: #6b7280;">
                ✅ Works from anywhere - not dependent on any server
              </p>
            </div>
          `).join('')}
        </div>
  ...
  try {
    const htmlContent = `
      ...
      <head>
        ...
        <style>
          ...
          .production-notice { background: #dbeafe; border: 1px solid #3b82f6; padding: 15px; border-radius: 6px; margin: 15px 0; }
        </style>
      </head>
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="production-notice">
              <h3 style="color: #1e40af; margin-top: 0;">🌐 Universal Access</h3>
              <p style="margin: 0; color: #1e40af;">
                <strong>These download links work from anywhere in the world</strong> and are not dependent on any development server. 
                You can access them from any device, any location, at any time before they expire.
              </p>
            </div>
            ...
            <div class="summary">
              ...
              <p><strong>Access URL:</strong> ${baseUrl}</p>
            </div>
            ...
            <div class="security-notice">
              ...
              <ul style="margin: 0;">
                ...
                <li><strong>Universal Access:</strong> Works from any location, any device</li>
              </ul>
            </div>
            ...
            <div style="background: #dbeafe; border: 1px solid #3b82f6; padding: 20px; border-radius: 8px; margin: 20px 0;">
              ...
              <ol style="margin: 0;">
                ...
                <li><strong>Note:</strong> These links work from anywhere - no server dependency!</li>
              </ol>
            </div>
            ...
            <p>Thank you for choosing TechCreator. Download your files securely from anywhere!</p>
          </div>
          
          <div class="footer">
            <p>&copy; 2025 TechCreator. All rights reserved.</p>
            <p>This email contains secure, time-limited download links that work universally.</p>
          </div>
        </div>
      </body>
      </html>
    ...
    const emailData: BrevoEmailData = {
      ...
      htmlContent,
      tags: ['secure-document-delivery', 'time-limited', 'transactional', 'production-ready']
    };
...
IMPORTANT: All download links work from anywhere in the world and are not dependent on any development server.
